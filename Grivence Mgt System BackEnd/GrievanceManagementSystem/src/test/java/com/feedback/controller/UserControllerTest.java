...
public class UserControllerTest {
    ...
    void testGetUserByUserName() {
        UserProfileDTOout userProfileDTOout = new UserProfileDTOout("John Doe", "johndoe", "password123", "Admin", "IT");

        when(userService.getByUserByUserName("johndoe")).thenReturn(userProfileDTOout);

        ResponseEntity<?> responseEntity = userController.getUserByUserName("johndoe");
